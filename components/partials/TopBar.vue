<template>
  <div class="topbar">
    <div class="logo">
      <h1>
        <NuxtLink to="/"><img src="/images/logo1.png" alt="" /></NuxtLink>
      </h1>
    </div>
    <div class="topbar-data">
      <ul class="tobar-links">
        <li>
          <a href="#" title=""
            ><i class="ion-ios-bell"></i><span class="blue-bg">02</span></a
          >
        ...
        <li>
          <a href="#" title=""><i class="ion-android-settings"></i></a>
          <div class="set-lst">
            <div class="set-bd">
        ...
        <li>
          <a href="#" title=""><i class="ion-android-contacts"></i></a>
          <div class="cnt-lst">
            <ul>
              <li>
                <div class="usr">
      ...
      >
        <span
          ><img src="/images/resource/topbar-usr1.jpg" alt="" /><i
            class="sts away"
          ></i
        ></span>
        <div class="usr-inf">
          <div class="usr-thmb brd-rd50 mb-">
          ...
          <i>{{ $auth.user.email }}</i>
          <div class="act-pst-lk-stm"></div>
          <div class="usr-ft mt-5">
            <a class="btn-danger" @click="onLogout"
              ><i class="fa fa-sign-out"></i> Se decoonecter</a
            >
          </div>
        </div>
      </div>
