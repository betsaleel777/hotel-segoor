...
export default {
  ...
  methods: {
    ...
    //     if (!isNaN(this.quantite) && this.article) {
    //       this.$axios
    //         .get('restaurant/achats/en-stock/' + this.article.id)
    //         .then((result) => {
    ...
    //   if (index !== -1) {
    //     quantiteDemandee =
    //       parseFloat(articles[index].quantite) + parseFloat(this.quantite)
    //   } else {
