        ...
        <div class="row grid-wrap mrg20">
                ...
                <div class="col m5 col s12 col l5">
                  <div class="trfc-cnt">
                    ...
                    <p>
                      ...
                      sed do eiusmod tempor. Ipsum is simply dummy text of the
              ...
              <div class="sales-stat">
                ...
                <div class="sales-stat-itm">
                  <span style="color: #968cec"
                    >$ <i class="counter">4,219</i></span
                  >
                  <i>Revenus</i>
                </div>
                <div class="sales-stat-itm">
                  <span style="color: #968cec"
                    >$ <i class="counter">1,247</i></span
                  >
                  <i>Expenses</i>
                </div>
              </div>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="prj-tl">
                          ...
                          <span
                            ><i class="ion-ios-stopwatch"></i> Created: 10
                            July</span
                          >
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="prj-tl">
                          ...
                          <span
                            ><i class="ion-ios-stopwatch"></i> Created: 22
                            June</span
                          >
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="prj-tl">
                          ...
                          <span
                            ><i class="ion-ios-stopwatch"></i> Created: 15
                            June</span
                          >
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="prj-tl">
                          ...
                          <span
                            ><i class="ion-ios-stopwatch"></i> Created: 09
                            June</span
                          >
                        </div>
                      </td>
              ...
              <div class="caht-wrp">
                <div class="chat-lst">
                  <div class="chat-msg yur-msg">
                    <img
                      class="brd-rd50"
                      src="images/resource/acti-thmb1.jpg"
                      alt=""
                    />
                    <div class="msg-inf2">
                      <h5>John Doe</h5>
                      ...
                      >
                      <p>
                        Aenean massa. Cum sociis natoque penatibus et mag nis
                        dis parturient montes, nascetur ridiculus mus. Do nec
                      ...
                      <div class="snd-fl">
                        <div class="fl-itm brd-rd5">
                          <img
                            class="brd-rd5"
                            src="images/resource/fl-img1.png"
                            alt=""
                          />
                      ...
                      <div class="act-pst-lk-stm">
                        <a href="#" title="" class="brd-rd5 green-bg-hover"
                          >Save</a
                        >
                        <a href="#" title="" class="brd-rd5 blue-bg-hover"
                          >Cancel</a
                        >
                      </div>
                    </div>
                  ...
                  <div class="chat-msg frnd-msg">
                    <img
                      class="brd-rd50"
                      src="images/resource/acti-thmb2.jpg"
                      alt=""
                    />
                    <div class="msg-inf2">
                      <h5>Kim Smith</h5>
          ...
          <div class="col m6 grid-item col s12 col l6">
            <div class="widget pad50-40">
              ...
              <h4 class="widget-title">
                Activity <span class="green-bg badge">05 Messages</span>
              </h4>
              <div class="slct-bx">
                <i>Added:</i>
                <span>
              ...
              <div class="act-pst-lst">
                <div class="act-pst">
                  ...
                  <div class="act-pst-inf">
                    <div class="act-pst-inr">
                      <h5><a href="#" title="">Sadi Orlaf</a></h5>
                      posted in <a href="#" title="">Material</a>
                    </div>
                ...
                <div class="act-pst">
                  ...
                  <div class="act-pst-inf">
                    <div class="act-pst-inr">
                      <h5><a href="#" title="">Overtunk</a></h5>
                      posted in <a href="#" title="">New Blog</a>
                    </div>
                ...
                <div class="act-pst">
                  <img
                    class="brd-rd50"
                    src="images/resource/acti-thmb3.jpg"
                    alt=""
                  />
                  <div class="act-pst-inf">
                    <div class="act-pst-inr">
                      <h5><a href="#" title="">Kim Smith</a></h5>
                      add <a href="#" title="">1 photo</a>
                    </div>
                ...
                <div class="act-pst">
                  <img
                    class="brd-rd50"
                    src="images/resource/acti-thmb4.jpg"
                    alt=""
                  />
                  <div class="act-pst-inf">
                    <div class="act-pst-inr">
                      <h5><a href="#" title="">Chris Johnathan</a></h5>
                      started following
                      <h6><a href="#" title="">Monica Smith</a></h6>
                      site.
                    </div>
                    <span class="spnd-tm">1 Hour Ago</span>
                    <div class="act-pst-dta"></div>
                    <span class="pst-tm"
                      ><a href="#" title=""
                        ><i class="fa fa-trash-o"></i> Remove</a
                      ></span
