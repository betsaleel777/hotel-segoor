        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" sm="6" md="10">
              <v-data-table
                no-data-text="Aucun employé archivé"
                ...
                <template #[`item.actions`]="{ item }">
                  <action-confirm
                    ...
                    action="maintenance/employe/restorer"
                  >
                    Voulez restaurer l'employé
                  ...
                  <action-confirm
                    ...
                    icon="delete"
                    action="maintenance/employe/supprimer"
                  >
                    Voulez vous réelement supprimer l'employé
                    <b>{{ item.nom.toUpperCase() }}</b
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'Archivé le', value: 'deleted_at', sortable: false },
  ...
  methods: {
    ...mapActions('maintenance/employe', ['getTrashed']),
    print() {
      printjs({
